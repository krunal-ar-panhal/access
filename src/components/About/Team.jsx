...
const Team = () => {
  ...
  <div className="row justify-content-center">
    ...
    <div className="col-md-3">
      <div className="card border-0 ">
        <img
          src="./assets/images/team member/Prof Hem 2.jpg"
  ...
  s            ><i class="fab fa-instagram fa-lg"></i
    ...
    <div className="col-md-3">
      <div className="card border-0 ">
        <img
          src="./assets/images/team member/Prof Saji 2.jpg"
          className="card-img-top"
    ...
    <div className="col-md-3">
      <div className="card border-0 ">
        ...
        >
          <img
            src="./assets/images/team member/Prof Vasa 2.jpg"
            className="card-img-top"
    ...
    <div className="col-md-3">
      <div className="card border-0 ">
        <img
          src="./assets/images/team member/Karthika 2.jpg"
          className="card-img-top"
    ...
    <div className="col-md-3">
      <div className="card border-0 ">
        <img
          src="./assets/images/team member/Swikriti.jpg"
          className="card-img-top"
    ...
    <div className="col-md-3">
      <div className="card border-0 ">
        <img
          src="./assets/images/team member/Subisha KR 2.jpg"
          className="card-img-top"
    ...
    <div className="col-md-3">
      <div className="card border-0 ">
        <img
          src="./assets/images/team member/Sadiq 2.jpg"
          className="card-img-top"
    ...
    <div className="col-md-3">
      <div className="card border-0 ">
        <img
          src="./assets/images/team member/Yuvaraj.jpg"
          className="card-img-top"
    ...
    <img
      src="./assets/images/team member/team-member.png"
