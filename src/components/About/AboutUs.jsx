            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 mb-lg-0">
                ...
                <p className="focus-text text-justify" tabIndex={0}>
                  At The Accessibility Research Centre, we are dedicated to
                  addressing the intersection of disability and academic
                  disciplines. We believe that current systems and fields of
                  knowledge are often unprepared to accommodate individuals with
                  disabilities, but we are committed to changing that. Our focus
                  is on tackling the complex Disability and Discipline (D&amp;D)
                  nexus—the existing gaps in our everyday knowledge of disabled
                  people's mobility across disciplines and the latter’s inherent
                  capacity to uphold the same.
                </p>
                <p className="focus-text text-justify" tabIndex={0}>
                  The ARC was established with the mission to reform learning
                  environments, both in schools and universities, by developing
                  solutions that go beyond individually oriented’ assistive
                  technology solutions. While tools like screen readers can be
                  helpful, they do not address the systemic nature of disability
                  exclusion. We hope to foster truly inclusive research,
                  teaching, learning, and collaborative environments. We
                  envision a future where accessibility is deeply integrated
                  into the core of every academic life.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="row border rounded g-0 mb-5">
              ...
              <div className="col-12 col-md-8 p-4">
                ...
                <p className="text-justify">
                  ...
                  accessible to all. By transforming all disciplines, digital
                  systems, and immersive technologies to meet the diverse needs
                  of individuals with disabilities, we hope to foster true
                  equality across places of learning, cultural institutions and
                  public spaces.
                </p>
              </div>
            </div>
            <div className="row border rounded g-0 mb-3">
              <div className="col-12 col-md-8 p-4 order-2 order-sm-1">
                ...
                <p className="text-justify">
                  ...
                  Through teacher training, innovative technologies, and
                  immersive solutions, we are working to ensure that all
                  individuals, regardless of impairments, have equal access to
                  knowledge and true empowerment.
                </p>
              </div>
